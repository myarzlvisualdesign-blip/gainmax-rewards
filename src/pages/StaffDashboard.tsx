...
import { LogOut, Users, Crown, DollarSign } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { Link } from "react-router-dom";
import type { Database } from "@/integrations/supabase/types";

type Profile = Database["public"]["Tables"]["profiles"]["Row"];
type Commission = Database["public"]["Tables"]["referral_commissions"]["Row"];
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-2xl bg-primary-foreground/10 p-4 backdrop-blur-sm">
              ...
              <p className="text-xs opacity-70">Total Anggota</p>
            </div>
            <div className="rounded-2xl bg-primary-foreground/10 p-4 backdrop-blur-sm">
              ...
              <p className="text-xs opacity-70">Total Komisi</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-2xl px-4 py-6">
        ...
        {/* Commissions */}
        <h3 className="mb-3 mt-8 text-lg font-bold text-foreground">Riwayat Komisi Referral</h3>
